    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('subject', models.CharField(choices=[('', '---------'), ('japanese', '国語'), ('math', '数学'), ('science', '科学'), ('society', '社会'), ('english', '英語'), ('health_and_physicaleducation', '保健体育'), ('technical_home_economics', '技術家庭科'), ('art', '美術'), ('music', '音楽'), ('art_sandcrafts', '図工'), ('information', '情報'), ('calligraphy', '書道')], max_length=30, verbose_name='教科')),
