...
urlpatterns = [
    ...
    path('home/study-time-update/<int:pk>', views.StudyTimeUpdateView.as_view(), name='study-time-update'),
    path('home/study-time-delete/<int:pk>', views.StudyTimeDeleteView.as_view(), name='study-time-delete'),
